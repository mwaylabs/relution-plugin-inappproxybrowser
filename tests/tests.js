...
exports.defineManualTests = function (contentEl, createActionButton) {
    ...
    function doOpen(url, target, params, numExpectedRedirects, useWindowOpen) {
        ...
        if (useWindowOpen) {
            ...
            iab = cordova.InAppProxyBrowser.open(url, target, params, callbacks);
        }
        if (!iab) {
    ...
    function doHookOpen(url, target, params, numExpectedRedirects) {
        ...
        window.open = cordova.InAppProxyBrowser.open;
    ...
    function openHidden(url, startHidden) {
        ...
        hiddenwnd = cordova.InAppProxyBrowser.open(url, 'random_string', shopt);
        if (!hiddenwnd) {
            alert('cordova.InAppProxyBrowser.open returned ' + hiddenwnd);
            return;
        }
    ...
    var info_div = '<h1>InAppProxyBrowser</h1>' +
        '<div id="info">' +
    ...
    var local_tests = '<h1>Local URL</h1>' +
        ...
        'Expected result: opens successfully in InAppProxyBrowser with locationBar at top.' +
        '<p/> <div id="openLocalRandomNoLocation"></div>' +
        'Expected result: opens successfully in InAppProxyBrowser without locationBar.' +
        '<p/> <div id="openLocalRandomToolBarBottom"></div>' +
        'Expected result: opens successfully in InAppProxyBrowser with locationBar. On iOS the toolbar is at the bottom.' +
        '<p/> <div id="openLocalRandomToolBarTop"></div>' +
        'Expected result: opens successfully in InAppProxyBrowser with locationBar. On iOS the toolbar is at the top.' +
        '<p/><div id="openLocalRandomToolBarTopNoLocation"></div>' +
        'Expected result: open successfully in InAppProxyBrowser with no locationBar. On iOS the toolbar is at the top.';
    ...
    var white_listed_tests = '<h1>White Listed URL</h1>' +
        ...
        'Expected result: open successfully in InAppProxyBrowser to cordova.apache.org' +
        '<p/> <div id="openWhiteListedRandom"></div>' +
        'Expected result: open successfully in InAppProxyBrowser to cordova.apache.org' +
        '<p/> <div id="openWhiteListedRandomNoLocation"></div>' +
        'Expected result: open successfully in InAppProxyBrowser to cordova.apache.org with no location bar.';

    var non_white_listed_tests = '<h1>Non White Listed URL</h1>' +
        '<div id="openNonWhiteListed"></div>' +
        'Expected result: open successfully in InAppProxyBrowser to apple.com.' +
        '<p/> <div id="openNonWhiteListedHook"></div>' +
        'Expected result: open successfully in InAppProxyBrowser to apple.com (using hook of window.open()).' +
        '<p/> <div id="openNonWhiteListedSelf"></div>' +
        'Expected result: open successfully in InAppProxyBrowser to apple.com (_self enforces whitelist).' +
        ...
        'Expected result: open successfully in InAppProxyBrowser to apple.com without locationBar.';

    var page_with_redirects_tests = '<h1>Page with redirect</h1>' +
        '<div id="openRedirect301"></div>' +
        'Expected result: should 301 and open successfully in InAppProxyBrowser to https://www.google.co.uk.' +
        '<p/> <div id="openRedirect302"></div>' +
        'Expected result: should 302 and open successfully in InAppProxyBrowser to www.zhihu.com/answer/16714076.';

    var pdf_url_tests = '<h1>PDF URL</h1>' +
        '<div id="openPDF"></div>' +
        'Expected result: InAppProxyBrowser opens. PDF should render on iOS.' +
        '<p/> <div id="openPDFBlank"></div>' +
        'Expected result: InAppProxyBrowser opens. PDF should render on iOS.';

    var invalid_url_tests = '<h1>Invalid URL</h1>' +
        '<div id="openInvalidScheme"></div>' +
        'Expected result: fail to load in InAppProxyBrowser.' +
        '<p/> <div id="openInvalidHost"></div>' +
        'Expected result: fail to load in InAppProxyBrowser.' +
        '<p/> <div id="openInvalidMissing"></div>' +
        'Expected result: fail to load in InAppProxyBrowser (404).';

    var css_js_injection_tests = '<h1>CSS / JS Injection</h1>' +
        '<div id="openOriginalDocument"></div>' +
        'Expected result: open successfully in InAppProxyBrowser without text "Style updated from..."' +
        '<p/> <div id="openCSSInjection"></div>' +
        'Expected result: open successfully in InAppProxyBrowser with "Style updated from file".' +
        '<p/> <div id="openCSSInjectionCallback"></div>' +
        'Expected result: open successfully in InAppProxyBrowser with "Style updated from file", and alert dialog with text "Results verified".' +
        '<p/> <div id="openCSSLiteralInjection"></div>' +
        'Expected result: open successfully in InAppProxyBrowser with "Style updated from literal".' +
        '<p/> <div id="openCSSLiteralInjectionCallback"></div>' +
        'Expected result: open successfully in InAppProxyBrowser with "Style updated from literal", and alert dialog with text "Results verified".' +
        '<p/> <div id="openScriptInjection"></div>' +
        'Expected result: open successfully in InAppProxyBrowser with text "Script file successfully injected".' +
        '<p/> <div id="openScriptInjectionCallback"></div>' +
        'Expected result: open successfully in InAppProxyBrowser with text "Script file successfully injected" and alert dialog with the text "Results verified".' +
        '<p/> <div id="openScriptLiteralInjection"></div>' +
        'Expected result: open successfully in InAppProxyBrowser with the text "Script literal successfully injected" .' +
        '<p/> <div id="openScriptLiteralInjectionCallback"></div>' +
        'Expected result: open successfully in InAppProxyBrowser with the text "Script literal successfully injected" and alert dialog with the text "Results verified".';
    ...
    var open_hidden_tests = '<h1>Open Hidden </h1>' +
        ...
        'Expected result: after first clicking on previous test "create hidden", open successfully in InAppProxyBrowser to https://www.google.co.uk.' +
        ...
        'Expected result: open successfully in InAppProxyBrowser to https://www.google.co.uk';
    ...
    var video_tag_tests = '<h1>Video tag</h1>' +
        ...
        'Expected result: open successfully in InAppProxyBrowser with an embedded video that works after clicking the "play" button.';

    var local_with_anchor_tag_tests = '<h1>Local with anchor tag</h1>' +
        '<div id="openAnchor1"></div>' +
        'Expected result: open successfully in InAppProxyBrowser to the local page, scrolled to the top as normal.' +
        '<p/> <div id="openAnchor2"></div>' +
        'Expected result: open successfully in InAppProxyBrowser to the local page, scrolled to the beginning of the tall div with border.';
